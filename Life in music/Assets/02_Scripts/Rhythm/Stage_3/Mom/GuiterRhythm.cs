...
public class GuiterRhythm : TutoMOM, IRhythmMom
{
    protected override void Start()
    {
        ...
        EventManager<GameObject>.StartListening(ConstantManager.GUITER_ADD, AddNoteList);
        CheckingTuto();
    }
    ...
    {
        var _isTutoGo = RhythmManager.Instance.CheckTuto(ConstantManager.SO_STAGE03_GUITER);
    ...
    private void StartRhythm()
    {
        ...
        RhythmManager.Instance.ReadyRhythm(ConstantManager.SO_STAGE03_GUITER);
    }
