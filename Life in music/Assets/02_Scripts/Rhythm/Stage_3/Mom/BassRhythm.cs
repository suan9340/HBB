...
public class BassRhythm : TutoMOM, IRhythmMom
{
    protected override void Start()
    {
        ...
        EventManager<GameObject>.StartListening(ConstantManager.BASS_ADD, AddNoteList);
        CheckingTuto();
    }
    ...
    {
        var _isTutoGo = RhythmManager.Instance.CheckTuto(ConstantManager.SO_STAGE03_BASS);
    ...
    private void StartRhythm()
    {
        ...
        RhythmManager.Instance.ReadyRhythm(ConstantManager.SO_STAGE03_BASS);
    }
